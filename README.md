...
[![Version](https://img.shields.io/badge/version-1.0.0-blue?logo=semver&logoColor=white)](https://github.com/your-repo/Plant_Village_Pepper)
[![GitHub stars](https://img.shields.io/github/stars/your-repo/Plant_Village_Pepper?style=flat&logo=github&label=Stars&color=orange&labelColor=orange&logoColor=white)](https://github.com/your-repo/Plant_Village_Pepper)
[![GitHub forks](https://img.shields.io/github/forks/your-repo/Plant_Village_Pepper?style=flat&logo=github&label=Forks&color=yellow&labelColor=yellow&logoColor=white)](https://github.com/your-repo/Plant_Village_Pepper)
[![GitHub watchers](https://img.shields.io/github/watchers/your-repo/Plant_Village_Pepper?style=flat&logo=github&label=Watchers&color=cyan&labelColor=cyan&logoColor=white)](https://github.com/your-repo/Plant_Village_Pepper)
[![GitHub issues](https://img.shields.io/github/issues/your-repo/Plant_Village_Pepper?style=flat&logo=github&label=Issues&color=red&labelColor=red&logoColor=white)](https://github.com/your-repo/Plant_Village_Pepper/issues)
[![GitHub pull requests](https://img.shields.io/github/issues-pr/your-repo/Plant_Village_Pepper?style=flat&logo=github&label=PRs&color=lime&labelColor=lime&logoColor=white)](https://github.com/your-repo/Plant_Village_Pepper/pulls)
[![GitHub contributors](https://img.shields.io/github/contributors/your-repo/Plant_Village_Pepper?style=flat&logo=github&label=Contributors&color=purple&labelColor=purple&logoColor=white)](https://github.com/your-repo/Plant_Village_Pepper/graphs/contributors)
[![GitHub last commit](https://img.shields.io/github/last-commit/your-repo/Plant_Village_Pepper?style=flat&logo=github&label=Last%20Commit&color=gray&labelColor=gray&logoColor=white)](https://github.com/your-repo/Plant_Village_Pepper/commits)
...
Pepper leaf disease classification dataset from Plant Village. Contains images of pepper leaves labeled for disease classification (healthy, bacterial spot). This dataset follows the standardized layout specification.
...
- **Classes**: 2 categories
  - `bacterial_spot`: Images with bacterial spot disease
  - `healthy`: Healthy pepper leaves
...
│   ├── peppers_instances_train.json
│   ├── peppers_instances_val.json
│   └── peppers_instances_test.json
├── scripts/
...
- Splits: `peppers/sets/*.txt` list image basenames (no extension). If missing, all images are used.
...
<table>
  ...
  <tr>
    ...
    <td>
      <img src="peppers/bacterial_spot/images/sample.jpg" alt="bacterial_spot" width="260"/>
      <div align="center"><code>peppers/bacterial_spot/images/sample.jpg</code></div>
    </td>
  </tr>
  <tr>
    <td><strong>Healthy</strong></td>
    <td>
      <img src="peppers/healthy/images/sample.jpg" alt="healthy" width="260"/>
      <div align="center"><code>peppers/healthy/images/sample.jpg</code></div>
    </td>
  </tr>
</table>
...
- **CSV per-image schema** (stored under `peppers/{subcategory}/csv/` folder):
...
- **Label maps**: `peppers/labelmap.json` defines the category mapping:
...
- **Splits provided via** `peppers/sets/*.txt`. You may define your own splits by editing those files.
...
coco = COCO('annotations/peppers_instances_train.json')
...
This dataset was created to support research in plant disease detection and classification, specifically for pepper leaf diseases, which is crucial for automated disease detection in agricultural applications.

### Composition

The dataset consists of:
- **Image types**: RGB images of pepper leaves
- **Categories**: 2 classes (bacterial_spot, healthy)
