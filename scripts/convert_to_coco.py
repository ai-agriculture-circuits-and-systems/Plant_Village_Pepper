#!/usr/bin/env python3
"""
Convert peppers dataset annotations to COCO JSON format.
...
def main():
    parser = argparse.ArgumentParser(description="Convert peppers annotations to COCO JSON")
    parser.add_argument(
        "--root",
        type=Path,
